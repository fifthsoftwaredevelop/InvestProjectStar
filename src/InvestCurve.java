...
public class InvestCurve {
	...
	public void drawpanel() throws ParseException {
		...
		JFreeChart jfreechart = ChartFactory.createTimeSeriesChart("投资曲线",
				"日期", "投资金额", xydataset, true, true, true);
	...
	private static XYDataset createDataset() throws ParseException { // 这个数据集有点多，但都不难理解
		TimeSeries timeseries = new TimeSeries("投资金额曲线",
